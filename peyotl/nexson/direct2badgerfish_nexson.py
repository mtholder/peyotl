...
from ..phylo_syntax import PhyloSyntax, to_nexml2json
# noinspection PyProtectedMember
from .helper import (_add_redundant_about, _convert_hbf_meta_val_for_xml,
                     NexsonConverter, get_nexml_el, )


class Direct2BadgerfishNexson(NexsonConverter):
    """Conversion of the 1.0 -> 0.0
    ...
    def convert(self, obj):
        ...
        nex['@nexml2json'] = to_nexml2json[PhyloSyntax.NEXSON_0]
